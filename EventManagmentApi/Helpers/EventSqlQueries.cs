namespace EventManagmentApi.Helpers
{
    public class EventSqlQueries // comandos SQL para los Eventos
    {
        ...
        INSERT INTO Events (Name, Description, Location, Date, Price, ImageUrl, ""Longitude"", ""Latitude"")
        VALUES (@Name, @Description, @Location, @Date, @Price, @ImageUrl, @Longitude, @Latitude)
        RETURNING Id";
        ...
        Price = @Price, ImageUrl = @ImageUrl, ""Longitude"" = @Longitude, ""Latitude"" = @Latitude
        WHERE Id = @Id";
